...
const version = "v-2020-11-30 slim";

const description = document.head.querySelector( "[ name=description ]" ).content;

//const urlDefault = "README.md";
MAP.latitude = MAP.defaultLatitude = 37.75;
MAP.longitude = MAP.defaultLongitude = -122.4;
MAP.zoom = MAP.defaultZoom = 13;
MAP.rows = MAP.defaultRows = 4;
MAP.cols = MAP.defaultCols = 4;
